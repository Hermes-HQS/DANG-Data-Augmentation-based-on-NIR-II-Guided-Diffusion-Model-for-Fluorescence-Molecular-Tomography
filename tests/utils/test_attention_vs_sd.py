...
from NIR_II_Guided_Diffusion.models.utils.attention_blocks import LinearTransformer,LinearTransformerNd, SpatialTransformer

from NIR_II_Guided_Diffusion.external.stable_diffusion.unet_openai import AttentionBlock
from NIR_II_Guided_Diffusion.external.stable_diffusion.attention import SpatialSelfAttention # similar/equal to Attention used SD-UNet implementation 
