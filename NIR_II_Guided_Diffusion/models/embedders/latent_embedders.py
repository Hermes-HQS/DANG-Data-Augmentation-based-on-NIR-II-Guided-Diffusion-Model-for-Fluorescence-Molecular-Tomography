...
from NIR_II_Guided_Diffusion.models.utils.conv_blocks import DownBlock, UpBlock, BasicBlock, BasicResBlock, UnetResBlock, UnetBasicBlock
from NIR_II_Guided_Diffusion.loss.gan_losses import hinge_d_loss
from NIR_II_Guided_Diffusion.loss.perceivers import LPIPS
from NIR_II_Guided_Diffusion.models.model_base import BasicModel, VeryBasicModel
...
class VAE(BasicModel):
    ...
    def rec_loss(self, pred, pred_vertical, target):
        ...
        loss = torch.mean(rec_loss)  # 使用 mean 或 sum 确保标量输出
